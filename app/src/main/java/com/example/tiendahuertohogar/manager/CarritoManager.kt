...
object CarritoManager {
     ...
     */
    fun agregarProducto(producto: com.example.tiendahuertohogar.data.model.Producto) {
        ...
        if (itemExistente != null) {
            ...
            _items.add(CartItem(producto = producto, cantidad = 1))
        }
    }
     ...
     */
    fun cambiarCantidad(item: CartItem, nuevaCantidad: Int) {
        if (nuevaCantidad <= 0) {
            eliminarItem(item)
            return
        }
